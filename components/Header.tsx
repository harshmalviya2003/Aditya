...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[#007B8A] text-white py-2 px-4 hidden md:block">
      ...
      <p className="text-sm text-[#007B8A] font-medium">Home Care Agency</p>
        ...
        {isMenuOpen && (
          <div className="lg:hidden fixed inset-0 z-50 bg-black bg-opacity-50" onClick={toggleMenu}>
            <div 
              className="absolute right-0 top-0 h-full w-80 bg-[#A2E3E2] shadow-xl transform transition-transform duration-300 ease-in-out"
